                ...
                <div class="card">
                        ...
                        <div class="header-elements ">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a href="{{route('segments.index')}}" class="dropdown-item load_not_ajax">
                                        Danh sách
                                    </a>
                                    <a href="{{ route('segments.edit', $row['_id']) }}" class="dropdown-item load_not_ajax">
                                        Sửa
                                    </a>
                                </div>
                            </div>
                    ...
                    <div class="card-body row">
                        <table class="table" width="100%">
                            ...
                            <tr>
                                <th>Người tạo:</th>
                                <td class="em-profile" data-id="{{ $row['created_by'] ?? '' }}">{{ $row['created_by'] ?? '' }}</td>
                            </tr>
                            <tr>
                                <th>Thời gian tạo:</th>
